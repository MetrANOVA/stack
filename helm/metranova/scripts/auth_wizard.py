...
def _format_enforcement_report(data: dict) -> str:
    ...
    if total == 0:
        lines += [
            ...
            "    --kafka-bootstrap <external-ip>:9095 \\",
            "    --kafka-sasl-username pipeline-user-scram \\",
            "    --kafka-sasl-password <from: kubectl get secret pipeline-user-scram ...> \\",
            "    --kafka-sasl-mechanism SCRAM-SHA-512 \\",
            "    --kafka-topic metranova_flow \\",
            "    --as-src 293 --interval 0",
            "",
            "  # Get IP:   kubectl get svc -n metranova | grep external-bootstrap",
